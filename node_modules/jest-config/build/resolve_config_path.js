...
function _load_constants() {return _constants = require('./constants');}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };} /**
                                                                                                                                                                       ...
                                                                                                                                                                       *
                                                                                                                                                                       * 
                                                                                                                                                                       */const isFile = filePath => (_fs || _load_fs()).default.existsSync(filePath) && !(_fs || _load_fs()).default.lstatSync(filePath).isDirectory();exports.default = (pathToResolve, cwd) => {if (!(_path || _load_path()).default.isAbsolute(cwd)) {throw new Error(`"cwd" must be an absolute path. cwd: ${cwd}`);
  }
