...
const MOCKS_PATTERN = (_path || _load_path()).default.sep + '__mocks__' + (_path || _load_path()).default.sep; /**
                                                                                                                ...
                                                                                                                *
                                                                                                                * 
                                                                                                                */const getMockName = filePath => {const mockPath = filePath.split(MOCKS_PATTERN)[1];return mockPath.substring(0, mockPath.lastIndexOf((_path || _load_path()).default.extname(mockPath))).replace(/\\/g, '/');};exports.default =
