...
const VERSION = require('../../package.json').version; /**
                                                        ...
                                                        *
                                                        * 
                                                        */function run(cliArgv, cliInfo) {const realFs = require('fs');const fs = require('graceful-fs');fs.gracefulify(realFs);let argv;if (cliArgv) {argv = cliArgv;} else {
  ...
  if (argv.help) {
    ...
    process.on('exit', () => (0, (_exit || _load_exit()).default)(1));
    return;
  }
