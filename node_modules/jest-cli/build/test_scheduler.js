'use strict';Object.defineProperty(exports, "__esModule", { value: true });var _slicedToArray = function () {function sliceIterator(arr, i) {var _arr = [];var _n = true;var _d = false;var _e = undefined;try {for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) {_arr.push(_s.value);if (i && _arr.length === i) break;}} catch (err) {_d = true;_e = err;} finally {try {if (!_n && _i["return"]) _i["return"]();} finally {if (_d) throw _e;}}return _arr;}return function (arr, i) {if (Array.isArray(arr)) {return arr;} else if (Symbol.iterator in Object(arr)) {return sliceIterator(arr, i);} else {throw new TypeError("Invalid attempt to destructure non-iterable instance");}};}();var _chalk;
...
function _load_chalk() {return _chalk = _interopRequireDefault(require('chalk'));}var _jestMessageUtil;
...
function _load_default_reporter() {return _default_reporter = _interopRequireDefault(require('./reporters/default_reporter'));}var _exit;
function _load_exit() {return _exit = _interopRequireDefault(require('exit'));}var _notify_reporter;
...
class TestScheduler {
  ...
  scheduleTests(tests, watcher) {var _this = this;return _asyncToGenerator(function* () {
      ...
      const onResult = (() => {var _ref = _asyncToGenerator(function* (test, testResult) {
          ...
          if (testResult.leaks) {
            const message =
            (_chalk || _load_chalk()).default.red.bold('EXPERIMENTAL FEATURE!\n') +
