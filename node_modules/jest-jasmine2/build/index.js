'use strict';let jasmine2 = (() => {var _ref = _asyncToGenerator(
  ...
  testPath)
  {
    ...
    if (config.testLocationInResults === true) {
      ...
      environment.global.it = function () {
        const stack = (0, _callsites2.default)()[1];
      ...
      retrieveSourceMap: function (source) {
        if (runtime._sourceMapRegistry[source]) {
          try {
            return {
              map: JSON.parse(
              _fs2.default.readFileSync(runtime._sourceMapRegistry[source])),
  ...
  });return function jasmine2(_x, _x2, _x3, _x4, _x5) {return _ref.apply(this, arguments);};})();var _path = require('path');var _path2 = _interopRequireDefault(_path);var _fs = require('fs');var _fs2 = _interopRequireDefault(_fs);var _callsites = require('callsites');var _callsites2 = _interopRequireDefault(_callsites);var _reporter = require('./reporter');var _reporter2 = _interopRequireDefault(_reporter);var _jasmine_async = require('./jasmine_async');function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _asyncToGenerator(fn) {return function () {var gen = fn.apply(this, arguments);return new Promise(function (resolve, reject) {function step(key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {return Promise.resolve(value).then(function (value) {step("next", value);}, function (err) {step("throw", err);});}}return step("next");});};} // eslint-disable-next-line import/no-extraneous-dependencies
/**
