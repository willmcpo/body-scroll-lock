...
NamedNodeMap.prototype.getNamedItem = function getNamedItem(qualifiedName) {
  ...
  if (arguments.length < 1) {
    throw new TypeError(
      "Failed to execute 'getNamedItem' on 'NamedNodeMap': " +
...
NamedNodeMap.prototype.getNamedItemNS = function getNamedItemNS(namespace, localName) {
  ...
  if (arguments.length < 2) {
    throw new TypeError(
      "Failed to execute 'getNamedItemNS' on 'NamedNodeMap': " +
...
NamedNodeMap.prototype.setNamedItem = function setNamedItem(attr) {
  ...
  args[0] = convertAttr(args[0], { context: "Failed to execute 'setNamedItem' on 'NamedNodeMap': parameter 1" });
...
NamedNodeMap.prototype.setNamedItemNS = function setNamedItemNS(attr) {
  ...
  if (arguments.length < 1) {
    throw new TypeError(
      "Failed to execute 'setNamedItemNS' on 'NamedNodeMap': " +
        "1 argument required, but only " +
        arguments.length +
        " present."
    );
  ...
  args[0] = convertAttr(args[0], { context: "Failed to execute 'setNamedItemNS' on 'NamedNodeMap': parameter 1" });
...
NamedNodeMap.prototype.removeNamedItemNS = function removeNamedItemNS(namespace, localName) {
  ...
  if (arguments.length < 2) {
    throw new TypeError(
      "Failed to execute 'removeNamedItemNS' on 'NamedNodeMap': " +
        "2 arguments required, but only " +
        arguments.length +
        " present."
    );
