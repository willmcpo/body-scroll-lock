...
SVGStringList.prototype.initialize = function initialize(newItem) {
  ...
  if (arguments.length < 1) {
    throw new TypeError(
      "Failed to execute 'initialize' on 'SVGStringList': " +
...
SVGStringList.prototype.getItem = function getItem(index) {
  ...
  if (arguments.length < 1) {
    throw new TypeError(
      "Failed to execute 'getItem' on 'SVGStringList': " +
        "1 argument required, but only " +
        arguments.length +
        " present."
    );
...
SVGStringList.prototype.insertItemBefore = function insertItemBefore(newItem, index) {
  ...
  if (arguments.length < 2) {
    throw new TypeError(
      "Failed to execute 'insertItemBefore' on 'SVGStringList': " +
...
SVGStringList.prototype.replaceItem = function replaceItem(newItem, index) {
  ...
  if (arguments.length < 2) {
    throw new TypeError(
      "Failed to execute 'replaceItem' on 'SVGStringList': " +
        "2 arguments required, but only " +
        arguments.length +
        " present."
    );
...
SVGStringList.prototype.removeItem = function removeItem(index) {
  ...
  if (arguments.length < 1) {
    throw new TypeError(
      "Failed to execute 'removeItem' on 'SVGStringList': " +
        "1 argument required, but only " +
        arguments.length +
        " present."
    );
...
SVGStringList.prototype.appendItem = function appendItem(newItem) {
  ...
  if (arguments.length < 1) {
    throw new TypeError(
      "Failed to execute 'appendItem' on 'SVGStringList': " +
        "1 argument required, but only " +
        arguments.length +
        " present."
    );
