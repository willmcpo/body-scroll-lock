...
let runTestInternal = (() => {var _ref = _asyncToGenerator(function* (
  path,
  globalConfig,
  config,
  resolver)
  {
    ...
    const consoleFormatter = function (type, message) {return (
    ...
    try {
      const result = yield testFramework(
      globalConfig,
      config,
      environment,
      runtime,
      ...
      return new Promise(function (resolve) {
        setImmediate(function () {return resolve({ leakDetector, result });});
      });
    } finally {
...
(_jestJasmine || _load_jestJasmine()).default;exports.default = (() => {var _ref2 = _asyncToGenerator(function* (path, globalConfig, config, resolver) {var _ref3 = yield runTestInternal(path,
    globalConfig,
    config,
    resolver);const leakDetector = _ref3.leakDetector,result = _ref3.result;
    ...
    return result;
  });function runTest(_x5, _x6, _x7, _x8) {return _ref2.apply(this, arguments);}return runTest;})();