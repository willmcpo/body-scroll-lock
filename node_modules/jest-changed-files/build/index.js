'use strict';Object.defineProperty(exports, "__esModule", { value: true });exports.findRepos = exports.getChangedFilesForRoots = undefined;var _git;
...
const mutex = (0, (_throat || _load_throat()).default)(5);const findGitRoot = dir => mutex(() => (_git || _load_git()).default.getRoot(dir));const findHgRoot = dir => mutex(() => (_hg || _load_hg()).default.getRoot(dir));const getChangedFilesForRoots = exports.getChangedFilesForRoots = (() => {var _ref = _asyncToGenerator(function* (
  roots,
  options)
  {
...
const findRepos = exports.findRepos = (() => {var _ref2 = _asyncToGenerator(function* (roots) {
